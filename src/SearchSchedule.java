...
public class SearchSchedule extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        srchFldCBX.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "FTrain_no", "FStn_code", "Arrival", "Departure", "Days", "Quota" }));
        ...
        UsersTbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "FTrain_no", "FStn_code", "Arrival", "Departure", "Travelled", "Days", "Quota"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String op   = (String) opCBX.getSelectedItem();
            String crit = criteriaTF.getText();
            String query = "SELECT Ftrain_no,Fstn_code,Arrival,Departure,Travelled,Days,Quota FROM schedule WHERE " + sfld + " " + op + "\'" + crit + "\' ;";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Updateschedule oo = new Updateschedule();
        oo.setVisible(true);
        this.dispose();
        // TODO add your handling code here:
